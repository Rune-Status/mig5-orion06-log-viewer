...
final class Texture extends DrawingArea {
	...
	{
		anIntArrayArray1478 = null;
		for(int j = 0; j < textureCount+1; j++)
	...
	public static void method367()
	{
		if(anIntArrayArray1478 == null)
		{
			...
			for(int k = 0; k < textureCount+1; k++)
	...
	/*public static void method372(double d)
	{
		...
		for(int l = 0; l < textureCount+1; l++)
		...
		for(int i1 = 0; i1 < textureCount+1; i1++)
			method370(i1);
	...
	//public static Background aBackgroundArray1474s[] = new Background[textureCount+1];
	private static boolean[] aBooleanArray1475 = new boolean[textureCount+1];
	private static int[] anIntArray1476 = new int[textureCount+1];
	private static int anInt1477;
	private static int[][] anIntArrayArray1478;
	private static int[][] anIntArrayArray1479 = new int[textureCount+1][];
	public static int anIntArray1480[] = new int[textureCount+1];
	public static int anInt1481;
	public static int anIntArray1482[] = new int[0x10000];
	private static int[][] anIntArrayArray1483 = new int[textureCount+1][];
